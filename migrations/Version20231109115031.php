...
final class Version20231109115031 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE IF NOT EXISTS books (
        ...
        $this->addSql('CREATE TABLE IF NOT EXISTS types (
            id INT AUTO_INCREMENT NOT NULL,
        ...
        $this->addSql("INSERT INTO `notes` VALUES (1,'★','mhh'),(2,'★ ★','ok…'),(3,'★ ★ ★','bien')");
        $this->addSql("INSERT INTO `types` VALUES (1,'novel'),(2,'essay')");
        $this->addSql("INSERT INTO `users` VALUES 
        ...
        $this->addSql("INSERT INTO `books` VALUES 
